...
module.exports = {
    ...
    async execute(client, arg, M) {
        ...
        if (daily !== null && dailytimeout - (Date.now() - daily) > 0) {
            ...
            text += `*Broh You have already claimed your daily reward. you have to wait ${dailytime.hours} hour(s) ${dailytime.minutes} minute(s), ${dailytime.seconds} second(s)*`
        } else {
            text += `*You have claimed your Daily reward of 🎉:💵${dailyamount} dollars*`
